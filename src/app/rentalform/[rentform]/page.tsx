//src\app\rentalform\[rentform]\page.tsx
...
export default async function CarRentalForm({
  searchParams,
}: {
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr,1fr]  flex-col lg:flex-row">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="space-y-3 sm:space-y-4 bg-white rounded-lg p-4 sm:p-6">
            ...
            <Link
              href={`/dashboard/id?image=${image}&name=${name}&type=${type}&pricePerDay=${pricePerDay}`}
            >
          ...
          <Card className="lg:sticky lg:top-4 p-4 sm:p-6">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 ">
                ...
                <div>
                  <h3 className="text-base sm:text-lg font-semibold mt-4 sm:mt-12">
                    {name}
                  </h3>
